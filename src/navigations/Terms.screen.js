      ...
      <div className="flex-1 px-4 py-6 mt-4">
        <div className="max-w-xl mx-auto bg-white p-6 rounded-lg shadow border border-gray-200">
          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-4">
            <p>
              Welcome to SIMOnS! These terms and conditions outline the rules
            ...
            <h3 className="font-semibold text-gray-800">2. License</h3>
            <p>
              ...
            </p>
           

            <h3 className="font-semibold text-gray-800">3. User Content</h3>
            <p>
              ...
            </p>

            <h3 className="font-semibold text-gray-800">4. Disclaimer</h3>
            <p>
            ...
            </p>
          </div>
