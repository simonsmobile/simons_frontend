...
const CreateAccount = () => {
  ...
  const [email, setEmail] = useState(googleData.email || localStorage.getItem('username') || '');
      ...
      try {
        ...
        if (response.ok) {
          if (result.exists) {
            ...
            Notiflix.Notify.success('Please complete your profile information');
          }
        } else {
    ...
    <div className="flex flex-col min-h-screen bg-white">
      <div className="sticky top-0 z-10 bg-white shadow-sm px-4 py-3">
        <div className="flex items-center">
          ...
          <h1 className="text-lg font-semibold text-center flex-1">Create Account</h1>
      ...
      <div className="flex-1 overflow-auto px-4 py-6">
        <div className="max-w-md mx-auto">
          ...
          <form onSubmit={submitAction} className="space-y-4">
            ...
            <div>
              <select
                className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-accent appearance-none bg-white"
                value={gender}
            ...
            <div className="flex space-x-3">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-accent pr-10"
                  value={password}
            ...
            {password && (
              <div className="mt-2 mb-4 w-full">
                ...
                <div className="mt-2 grid grid-cols-2 gap-y-1 gap-x-2">
                  ...
                  <div className="flex items-center text-xs">
                    <span className={`mr-1 ${/[\W_]/.test(password) ? 'text-green-500' : 'text-gray-400'}`}>
                      {/[\W_]/.test(password) ? '✓' : '○'}
                    </span>
