const env = {
  ...
  QS_MAIN: [
    ...
    },
    {
      title: "Question 8",
      question:
        "I know that some information on the Internet is false (e.g., fake news).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 10",
      question:
        "I know how to organize digital content (e.g., documents, images, videos) using folders or tagging to find them back later.",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 11",
      question:
        "I know how to copy and move files (e.g., documents, images, videos) between folders, devices, or on the cloud.",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 12",
      question:
        "I know how to manage and analyse data using software (e.g. sorting, filtering, calculations)",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 14",
      question:
        "I know that many communication services and social media are free of charge because they are paid for by advertising",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 15",
      question:
        "I know how to use advanced videoconferencing features (e.g. moderating, recording audio and video)",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 19",
      question:
        "I know how to change who I share content with (e.g. friends, friends of friends, everyone).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 20",
      question:
        "I know how to reference the source of documents (e.g. the author or web address) that I found online.",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 21",
      question:
        "I know how to apply for a job using a digital platform (e.g. fill in a form, upload my CV and photo).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 24",
      question:
        "It matters to me to debate social or political issues online (e.g. in online forums, news sites, Facebook, Twitter).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 27",
      question:
        "I know how to invite others and give appropriate permissions to collaborate on a shared document. ",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 28",
      question:
        "I am aware that I should ask permission from a person before publishing or sharing photos about them.",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 29",
      question:
        "I know how to recognise online messages and behaviours that attack certain groups or individuals (e.g. hate speech).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 32",
      question:
        "I know my digital identity is everything that identifies me in online environments (e.g. usernames, likes and posts on social media, petitions signed online).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 34",
      question:
        "I know that the EU introduced regulation on The Right to Be Forgotten (i.e. to have one s private information removed from the Internet).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 35",
      question:
        "I know how to configure the settings in my Internet browser to prevent or limit cookies.",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 37",
      question:
        "I know how to express myself by creating digital content on the Internet (e.g. blog post, video on YouTube)",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 39",
      question:
        "To express myself, I am careful to choose the right type of digital media depending on the audience and my aim (e.g. using social media to promote a project).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 41",
      question:
        "I know that some digital content can be reused and reworked legally (e.g. public domain or with Creative Commons licences).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 42",
      question:
        "I know how to edit or make changes to digital content that others have created (e.g. insert a text into an image, edit a wiki).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 44",
      question:
        "I am careful to follow the rules about copyrights and licenses of digital content that I find",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 47",
      question:
        "I know which different types of licences apply to the use of digital content (e.g. Creative Commons licences).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 49",
      question:
        "I know that programming languages (e.g. Python, Visual Basic, Java) are used to provide a digital device instructions to carry out a task",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 50",
      question:
        "I can write scripts, macros and simple applications to automate the execution of a task.",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 54",
      question:
        "I know how to configure the settings of a firewall on different devices.",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 55",
      question:
        "I know how to recover digital information and other content (e.g. photos, contacts) from a backup",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 56",
      question:
        "I know how to restrict or refuse access to my geographical location.",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 58",
      question:
        "I know how to check that the website where I am asked to provide personal data is secure (e.g. https sites, safety logo or certificate).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 71",
      question:
        "I am able to edit the configurations of the operating system of my digital devices to solve technical problems (e.g. automatic stop/start of services, modify registry keys)",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 74",
      question:
        "I know how to select the right tool, device or service to perform a given task (e.g. select a smartphone for my needs, choose a tool for a professional videocall).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 78",
      question:
        "I can use data tools (e.g. databases, data mining and analysis software) that manage and organize complex information to make decisions and solve problems.",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
    ...
    },
    {
      title: "Question 81",
      question:
        "I know how to use online learning tools to improve my digital skills (e.g. video tutorial, online courses).",
      options: [
        "I do not know",
        "I need some help",
        "I can do it by my own",
  ...
  QS_CAT: [
    {
      ...
      mainCategory: "Information & Data Literacy",
    },
    {
      id: 1,
      category: "1.2",
    ...
    },
    {
      ...
      mainCategory: "Com. & Collaboration",
    },
    {
      id: 4,
      category: "2.2",
    ...
    },
    {
      ...
      mainCategory: "Digital Content Creation",
    },
    {
      id: 10,
      category: "3.2",
    ...
    },
    {
      id: 19,
      category: "5.3",
      title: "Creatively using digital technologies",
      mainCategory: "Problem Solving",
    },
    {
      id: 20,
  ...
  QS_SAMPLE2: [
    ...
    },
    {
      title: "2.2 B2",
      question:
        "If you come across an infographic online and want to share it on social media, what should you do?",
      options: [
    ...
    },
    {
      title: "2.2 B3",
      question:
        "Suppose you need to share a file with your classmates which has approximately 1.4GB, which platform would you use?",
      options: ["Email", "WhatsApp", "WeTransfer", "Messenger"],
      answer: "WeTransfer",
      points: 1.0,
      type: "2.2",
      level: "basic",
    ...
    },
    {
      title: "2.2 B5",
      question:
        "Which information is important when citing an online book in the bibliographic references?",
      options: [
    ...
    },
    {
      title: "2.2 M1",
      question:
        "You found an interesting picture online which is protected by the following creative commons license. How can you reuse it?",
      options: [
    ...
    },
    {
      title: "2.2 M2",
      question:
        "When using images in school tasks that you found online, which is the most acceptable way to give attribution?",
      options: [
        "'Found it online'.",
    ...
    },
    {
      title: "2.2 M3",
      question:
        "The following paper was found on a publisher’s website: Robertson, C. T. (2023). Defining News from an Audience Perspective at a Time of Crisis in the United States. Journalism Practice, 17(2), 374–390. https://doi.org/10.1080/17512786.2021.1919178. Which facts regarding this article is correct?",
      options: [
    ...
    },
    {
      title: "2.2 M5",
      question:
        "If you go to Brussels, which of the following images can you not share online for commercial use, at least until 2076?",
      options: [
    ...
    },
    {
      title: "2.3 B1",
      question:
        "Which of the following is a digital service often used for paying university fees?",
      options: ["Facebook", "WeTransfer", "Online banking", "Instagram"],
    ...
    },
    {
      title: "2.3 B2",
      question:
        "Select the correct matching of the digital services with the most appropriate function.",
      options: [
    ...
    },
    {
      title: "2.3 B3",
      question:
        "Which is the most effective way of contacting the director of your university degree programme?",
      options: ["WhatsApp", "Email", "Instagram", "Mobile call"],
      answer: "Email",
      points: 1.0,
      type: "2.3",
      level: "basic",
    },
    {
      title: "2.3 B4",
      question:
        "Which of the following is an example of using digital technology to participate in civic engagement?",
      options: [
        "Shopping online",
    ...
    },
    {
      title: "2.3 M1",
      question:
        "Which digital technology can enhance transparency and accountability in civic engagement?",
      options: [
        "Virtual reality",
        "Blockchain",
        "Augmented reality",
    ...
    },
    {
      title: "2.3 M2",
      question:
        "You are supposed to write an essay on student perspectives about the use of mobile phones in the classroom. Which of the following instruments would be most appropriate to collect their opinions?",
      options: ["Survey", "Spreadsheets", "Mobile calls", "Email"],
      answer: "Survey",
      points: 1.0,
      type: "2.3",
      level: "master",
    },
    {
      title: "2.3 M3",
      question:
        "What could be the risks of having an AI algorithm predicting your grade in a certain curricular unit? Choose the most appropriate answer.",
      options: [
    ...
    },
    {
      title: "2.3 M4",
      question:
        "Select the correct matching between the concept and its definition:",
      options: [
    ...
    },
    {
      title: "2.3 M5",
      question:
        "A community organisation wants to increase awareness about local issues using digital tools. Which approach is most effective?",
      options: [
    ...
    },
    {
      title: "2.4 B1",
      question:
        "Which of the following is a benefit of using collaborative tools like Google Docs or Sheets for group projects?",
      options: [
        "Limited access",
        "Real-time updates",
    ...
    },
    {
      title: "2.4 B2",
      question:
        "Which of the following tools can help collecting feedback from your classmates?",
      options: [
        "Mentimeter",
        "Adobe Illustrator",
        "MS Sharepoint",
    ...
    },
    {
      title: "2.4 B4",
      question:
        "Which of the following best describes co-creation in the context of digital tools?",
      options: [
    ...
    },
    {
      title: "2.4 B5",
      question:
        "What is a primary benefit of using collaborative platforms like Google Docs for co-construction of knowledge?",
      options: [
    ...
    },
    {
      title: "2.4 M1",
      question:
        "What is the primary function of version control software like Git in collaborative projects?",
      options: [
        "To edit images",
    ...
    },
    {
      title: "2.4 M2",
      question:
        "In a collaborative setting, what is the main purpose of using a shared calendar tool like Google Calendar?",
      options: [
    ...
    },
    {
      title: "2.4 M4",
      question:
        "What is the purpose of using the 'track changes' option on MS Word?",
      options: [
    ...
    },
    {
      title: "2.4 M5",
      question:
        "A research team is using an online platform to collect data from participants and include themselves in the analysis. What approach are they using?",
      options: [
...

    {
      title: "2.5 B1",
      question:
        "Which of the following is an example of good netiquette in email communication?",
      options: [
    ...
    },
    {
      title: "2.5 B2",
      question:
        "How would you respond to a personal attack or provocation that violate the rules of an online moderated discussion group?",
      options: [
    ...
    },
    {
      title: "2.5 B4",
      question:
        "You are late for an online class and enter the video call in the middle of the session. What should you do?",
      options: [
    ...
    },
    {
      title: "2.5 B5",
      question:
        "What best practices are recommended for attending a remote class?",
      options: [
    ...
    },
    {
      title: "2.5 M1",
      question:
        "When presenting a group work to your peers, which of the following strategies might be most effective?",
      options: [
    ...
    },
    {
      title: "2.5 M2",
      question:
        "What, for instance, is considered hate speech on social media?",
      options: [
    ...
    },
    {
      title: "2.5 M3",
      question:
        "Which of the following aspects would make an academic presentation more inclusive?",
      options: [
    ...
    },
    {
      title: "2.5 M4",
      question:
        "Supposing you see a publication of your friend on social media supporting a classmate that has recently changed genders. What would be the most appropriate approach to raise awareness on gender inclusiveness?",
      options: [
    ...
    },
    {
      title: "2.5 M5",
      question:
        "You have finished a paperwork on a Sunday, and you decide to send it to your teacher by email. What is the most polite behaviour?",
      options: [
    ...
    },
    {
      title: "2.6 B1",
      question:
        "Which of the following is a good practice for managing multiple digital identities?",
      options: [
    ...
    },
    {
      title: "2.6 B2",
      question:
        "Which of the following practices is most effective for managing your digital identity and protecting your online reputation?",
      options: [
    ...
    },
    {
      title: "2.6 B3",
      question:
        "What is the best strategy for managing the data you produce online to protect your digital identity?",
      options: [
    ...
    },
    {
      title: "2.6 B4",
      question:
        "Which content directly threatens personal safety on social media?",
      options: [
        "Fake news",
    ...
    },
    {
      title: "2.6 M1",
      question:
        "What is one way to protect your personal data when creating online accounts?",
      options: [
    ...
    },
    {
      title: "2.6 M2",
      question:
        "How would you prevent mobile apps from collecting residual data from your device?",
      options: [
    ...
    },
    {
      title: "2.6 M4",
      question:
        "What should you do if someone steals your online identity (eg. social media profile)?",
      options: [
    ...
    },
    {
      title: "2.6 M5",
      question:
        "An official way to report any violations you had with your data is by contacting:",
      options: [
    ...
    },
    {
      ...
      options: ["Microsoft Excel", "Canva", "Microsoft PowerPoint", "Notepad"],
      answer: "Canva",
      points: 1.0,
      type: "3.1",
      level: "basic",
    ...
    },
    {
      title: "3.1 M2",
      question:
        "Which advanced technique is used to optimise digital content for search engines by understanding user intent and leveraging semantic keywords?",
      options: [
        "Keyword stuffing",
    ...
    },
    {
      title: "3.1 M3",
      question:
        "Which software is commonly used for creating interactive multimedia?",
      options: [
        "Adobe Flash",
        "Adobe Illustrator",
        "Adobe After Effects",
    ...
    },
    {
      title: "3.1 M4",
      question:
        "What is the importance of SEO (search engine optimization) in digital content?",
      options: [
    ...
    },
    {
      title: "3.2 B1",
      question:
        "Is it important to analyse which audience your digital content is aimed at?",
      options: ["Yes", "No"],
      answer: "Yes",
      points: 1.0,
      type: "3.2",
    ...
    },
    {
      title: "3.2 B2",
      question:
        "Which of the following tools is commonly used to create AI-generated images or artwork?",
      options: [
        "Word Processor",
    ...
    },
    {
      title: "3.2 B3",
      question:
        "Is the following sentence true or false? Sharing digital content online does not give the option to receive instant feedback on what has been published.",
      options: ["True", "False"],
      answer: "False",
      points: 1.0,
      type: "3.2",
    ...
    },
    {
      title: "3.2 B4",
      question:
        "Is the following sentence true or false? The more engagement you have with your audience, the more visibility your content receives.",
      options: ["True", "False"],
      answer: "True",
      points: 1.0,
      type: "3.2",
    ...
    },
    {
      title: "3.2 B5",
      question:
        "Is the following sentence true or false? Only the content has a targeted audience.",
      options: ["True", "False"],
      answer: "False",
      points: 1.0,
      type: "3.2",
    ...
    },
    {
      title: "3.2 M1",
      question:
        "What is the primary benefit of adding captions to video presentations?",
      options: [
    ...
    },
    {
      title: "3.2 M2",
      question:
        "You want to make an infographic about birth rate in your country. Which of the following is an online platform for data visualisation?",
      options: ["Flourish", "Canva", "Microsoft Power Point", "Google Forms"],
      answer: "Flourish",
      points: 1.0,
      type: "3.2",
      level: "master",
    },
    {
      title: "3.2 M3",
      question:
        "Why is the integration of story maps into digital content important?",
      options: [
    ...
    },
    {
      title: "3.2 M4",
      question:
        "Finish the sentence: Identify digital tools to help make your digital content…..",
      options: [
    ...
    },
    {
      title: "3.3 B1",
      question:
        "Software is protected by copyright which makes it illegal to what?",
      options: [
    ...
    },
    {
      title: "3.3 B2",
      question:
        "Which of the following could be examples of Fair Use? (select all that apply)",
      options: [
    ...
    },
    {
      title: "3.3 B4",
      question:
        "What is an important consideration when incorporating AI-generated content into your own work?",
      options: [
    ...
    },
    {
      title: "3.3 B5",
      question:
        "Which of the following is an example of a work protected by copyright?",
      options: [
    ...
    },
    {
      title: "3.3 M1",
      question:
        "Which of the following legal doctrines allows limited use of copyrighted works without permission under specific circumstances, such as commentary or criticism?",
      options: [
    ...
    },
    {
      title: "3.3 M2",
      question:
        "Which of the following is an example of 'copyleft' licensing in software development?",
      options: [
        "Apache License 2.0",
        "MIT License",
    ...
    },
    {
      title: "3.3 M3",
      question:
        "In the context of text and data mining (TDM), which EU directive facilitates the lawful extraction of data from copyrighted materials for research purposes without explicit permission, and under what condition?",
      options: [
    ...
    },
    {
      title: "3.3 M5",
      question:
        "I saw a picture online marked as 'Creative Commons.' Does that mean I can use it without violating copyright?",
      options: [
    ...
    },
    {
      title: "3.4 B4",
      question:
        "Which of the following elements is essential for creating a computer program?",
      options: [
        "Only graphics",
    ...
    },
    {
      title: "3.4 B5",
      question:
        "What is the main function of an 'if' statement in a programming language?",
      options: [
    ...
    },
    {
      ...
      options: ["Loop", "Array", "Repetition", "Sequential", "Selection"],
      answer: "Sequential",
      points: 1.0,
      type: "3.4",
      level: "master",
    ...
    },
    {
      title: "4.1 B1",
      question:
        "Which of the following is the most secure way to protect your device from malware?",
      options: [
    ...
    },
    {
      title: "4.1 B3",
      question:
        "What is a good practice for keeping personal data safe online?",
      options: [
    ...
    },
    {
      title: "4.1 B4",
      question:
        "Which of the following is a method to protect electronic devices from unauthorized access?",
      options: [
        "Disabling Wi-Fi",
    ...
    },
    {
      title: "4.1 B5",
      question:
        "What does the presence of a padlock in a web browser's address bar indicate?",
      options: [
    ...
    // },
    {
      title: "4.1 M1",
      question:
        "Which of the following methods can help protect your device from unauthorized access?",
      options: [
    ...
    },
    {
      title: "4.1 M2",
      question:
        "What is the main difference between a man-in-the-middle attack and a phishing attack?",
      options: [
    ...
    },
    {
      title: "4.2 B1",
      question:
        "How can you protect your personal data when using social media?",
      options: [
    ...
    },
    {
      title: "4.2 B2",
      question:
        "Which of the following best describes how companies use personal data under their privacy policy?",
      options: [
    ...
    },
    {
      title: "4.2 B5",
      question:
        "Which of the following can help protect your privacy when using digital services?",
      options: [
...

    {
      title: "4.2 M1",
      question:
        "Which cryptographic protocol is widely used to ensure secure communication over a computer network?",
    ...
    },
    {
      title: "4.2 M2",
      question:
        "What is the main purpose of encryption when sending personal data online?",
      options: [
    ...
    },
    {
      title: "4.2 M3",
      question:
        "How does the General Data Protection Regulation (GDPR) impact the use of personal data by digital services?",
      options: [
    ...
    },
    {
      title: "4.2 M4",
      question:
        "What should you do if you receive an email asking for personal information but you're unsure of its legitimacy?",
      options: [
    ...
    },
    {
      title: "4.2 M5",
      question:
        "How can understanding a service's privacy policy help protect you from data misuse?",
      options: [
    ...
    },
    {
      title: "4.3 B1",
      question:
        "How can you minimize the impact of digital device usage on your health and well-being?",
      options: [
    ...
    },
    {
      title: "4.3 B2",
      question:
        "What is one of the main physical health risks when using digital devices for prolonged periods?",
      options: [
    ...
    },
    {
      title: "4.3 B3",
      question:
        "Which of the following measures can help prevent cyberbullying?",
      options: [
    ...
    },
    {
      title: "4.3 B5",
      question:
        "Which of the following tools can help protect psychological well-being when using digital technologies?",
      options: [
    ...
    },
    {
      title: "4.3 M1",
      question:
        "What is a common sign of cyberbullying that one should be aware of in digital environments?",
      options: [
    ...
    },
    {
      title: "4.3 M2",
      question:
        "Why is awareness of privacy and security settings on social platforms important for mental health?",
      options: [
    ...
    },
    {
      title: "4.3 M3",
      question:
        "Which of the following best describes how digital competence can contribute to mental and social well-being?",
      options: [
    ...
    },
    {
      title: "4.3 M4",
      question:
        "What action can help create a safe and inclusive digital environment for others?",
      options: [
    ...
    },
    {
      title: "4.3 M5",
      question:
        "What is the effect of prolonged social media use on mental health, according to several studies?",
      options: [
    ...
    },
    {
      title: "4.4 B1",
      question:
        "Which of the following practices helps in protecting the environment?",
      options: [
    ...
    },
    {
      title: "4.4 B2",
      question:
        "Which of the following contributes to the environmental impact of digital technologies?",
      options: [
    ...
    },
    {
      title: "4.4 B5",
      question:
        "Which component of digital technology has the highest environmental impact?",
      options: [
...

    {
      title: "4.4 M1",
      question:
        "What practice can help minimize the environmental impact of electronic waste?",
      options: [
    ...
    },
    {
      title: "4.4 M2",
      question:
        "What is the main environmental concern regarding the production of digital devices?",
      options: [
    ...
    },
    {
      title: "4.4 M3",
      question:
        "Which of the following strategies can reduce the environmental impact of software development?",
      options: [
    ...
    },
    {
      title: "4.4 M4",
      question:
        "How does the production of semiconductors impact the environment?",
      options: [
    ...
    },
    {
      title: "4.4 M5",
      question:
        "Which of the following is a key factor in the environmental sustainability of digital services?",
      options: [
...

    {
      title: "5.1 B1",
      question:
        "What is the first step in troubleshooting a device that won’t turn on?",
      options: [
        "Replace the battery",
    ...
    },
    {
      title: "5.1 B2",
      question:
        "What should you do first when a device is not working as expected?",
      options: [
    ...
    },
    {
      title: "5.1 B3",
      question:
        "Which of the following is a common cause of a device overheating?",
      options: [
    ...
    },
    {
      title: "5.1 B4",
      question:
        "A device that is stuck on a loading screen may require a factory reset to resolve the issue.",
      options: ["True", "False"],
      answer: "True",
      points: 1.0,
      type: "5.1",
    ...
    },
    {
      title: "5.1 B5",
      question:
        "When experiencing issues with software, the first step to take is to check for ______ updates, as they often contain bug fixes.",
      options: ["Hardware", "Screen", "Software", "App"],
      answer: "Software",
      points: 1.0,
      type: "5.1",
      level: "basic",
    ...
    },
    {
      title: "5.1 M1",
      question:
        "You are unable to access a website, and other devices on the same network can. What is the most logical next step?",
      options: [
        "Restart the router",
    ...
    },
    {
      title: "5.1 M2",
      question:
        "Which of the following commands is used to test the reachability of a host on a network?",
    ...
    },
    {
      title: "5.1 M3",
      question:
        "When diagnosing an application that crashes randomly, which logs are the most useful?",
      options: [
    ...
    },
    {
      title: "5.1 M4",
      question:
        "Which of the following is NOT a likely cause of a Wi-Fi connectivity issue?",
      options: [
    ...
    },
    {
      title: "5.1 M5",
      question:
        "If your system displays the error 'No Bootable Device Found,' what is the most probable cause?",
      options: [
    ...
    },
    {
      title: "5.2 B1",
      question:
        "Which of the following digital tools would best support a user with limited mobility in their hands?",
      options: [
    ...
    },
    {
      title: "5.2 B2",
      question:
        "Is the following sentence True or False? “Screen readers are designed to help users with limited mobility by reading aloud the contents on the screen.”",
      options: ["True", "False"],
      answer: "False",
      points: 1.0,
      type: "5.2",
    ...
    },
    {
      title: "5.2 B3",
      question:
        "Which feature can help users with visual impairments use digital tools more effectively?",
      options: [
        "Night mode",
    ...
    },
    {
      title: "5.2 B4",
      question:
        "If you want to ensure your digital workspace has the correct accessibility options enabled, where should you start?",
      options: [
    ...
    },
    {
      title: "5.2 B5",
      question:
        "Is the following sentence true or false? “Using dark mode on a device can reduce eye strain for some users.”",
      options: ["True", "False"],
      answer: "True",
      points: 1.0,
      type: "5.2",
    ...
    },
    {
      title: "5.2 M1",
      question:
        "In the context of online transactions, what is the primary function of blockchain technology in enhancing transaction security?",
      options: [
    ...
    },
    {
      title: "5.2 M2",
      question:
        "What does UX customization typically focus on in advanced digital environments?",
      options: [
    ...
    },
    {
      title: "5.2 M3",
      question:
        "If someone with colour blindness needs to distinguish between colours on a webpage, which adjustment would be most beneficial?",
      options: [
    ...
    },
    {
      title: "5.2 M4",
      question:
        "Is the following sentence true or false? “Adaptive keyboards can be customised to support users with limited mobility, such as by enlarging key sizes or using predictive text.”",
      options: ["True", "False"],
      answer: "True",
      points: 1.0,
      type: "5.2",
    ...
    },
    {
      title: "5.2 M5",
      question:
        "Which digital tool would best support a user who struggles with reading small print on screens due to visual impairment?",
      options: [
    ...
    },
    {
      title: "5.3 B1",
      question:
        "Which digital tool would be most effective for brainstorming ideas collaboratively in real-time?",
      options: [
        "A word processor",
    ...
    },
    {
      title: "5.3 B2",
      question:
        "Which IoT technology is commonly used to optimise energy consumption in smart homes?",
      options: [
        "Smart Thermostats",
    ...
    },
    {
      title: "5.3 B4",
      question:
        "Which tool would be most suitable for designing a presentation?",
      options: ["Microsoft Excel", "Canva", "Zoom"],
      answer: "Canva",
      points: 1.0,
      type: "5.3",
      level: "basic",
    },
    {
      title: "5.3 B5",
      question:
        "Is the following sentence true or false? “Online brainstorming tools do not allow for collaborative contributions and are only useful for individual work.”",
      options: ["True", "False"],
      answer: "False",
      points: 1.0,
      type: "5.3",
    ...
    },
    {
      title: "5.3 M1",
      question:
        "Which of the following platforms is primarily known for providing comprehensive tools for building and managing IoT applications, including device management, data analytics, and security features?",
      options: [
        "AWS IoT Core",
        "Microsoft Word",
        "Adobe Photoshop",
    ...
    },
    {
      title: "5.3 M2",
      question:
        "Which of the following digital tools is most beneficial for managing and executing project plans to transform an idea into actionable steps?",
      options: [
    ...
    },
    {
      title: "5.3 M3",
      question:
        "For collaborative, creative problem-solving on a software project, which combination of tools is likely the most effective?",
      options: [
    ...
    },
    {
      title: "5.3 M4",
      question:
        "When designing a digital platform for community resource sharing, which of the following considerations is most crucial to ensure user trust and engagement?",
      options: [
    ...
    },
    {
      title: "5.4 B1",
      question:
        "Which of the following is a crucial first step in identifying your digital competence gaps?",
      options: [
    ...
    },
    {
      title: "5.4 B2",
      question:
        "Is the following sentence true or false? Identifying digital competence gaps is only relevant for technology-focused roles.",
      options: ["True", "False"],
      answer: "False",
      points: 1.0,
      type: "5.4",
    ...
    },
    {
      title: "5.4 B5",
      question:
        "When helping someone identify their digital competence gaps, what is the best approach?",
      options: [
    ...
    },
    {
      title: "5.4 M1",
      question:
        "Which of the following is the most effective first step in identifying your digital competence gaps?",
      options: [
    ...
    },
    {
      title: "5.4 M2",
      question:
        "What is a recommended way to stay updated with digital trends?",
      options: [
    ...
    },
    {
      title: "5.4 M3",
      question:
        "Is the following sentence true or false? Supporting others with digital competence involves assessing their abilities and encouraging continual skill development.",
      options: ["True", "False"],
      answer: "True",
      points: 1.0,
      type: "5.4",
    ...
    },
    {
      title: "5.4 M4",
      question:
        "Which of the following describes an approach to monitor and improve your digital competence over time?",
      options: [
    ...
    },
    {
      title: "5.4 M5",
      question:
        "To help a colleague improve their digital competence, what should be avoided?",
      options: [
